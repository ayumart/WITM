...
Q35. Which of the following strategies do you most rely on in raising external funding for your work?  

```{r q35, echo=F, message=F, warning=F}


```


Q36. In percentage, how much of your group, organization and/or movement's 
...
q41<-base %>% 
  ...
  summarise(Total=n()) %>% 
  mutate(Percentage=round((Total/sum(Total))*100,1))
  rename("Sufficient income" = q41_sufficient_income)

...
witm <- read.csv("Data/WITM_FINAL_FORMATED 5 SEPT 2024.csv", sep=";")
...
```{r upload_final, echo=F, message=F, warning=F}
...
ggplot(q19_yes, aes(x = reorder(Source, Percentage), y = Percentage, fill = Source)) +
  ...
  panel.grid.major.x = element_blank(), # Elimina líneas de la cuadrícula vertical
    panel.grid.minor.x = element_blank(), # Elimina líneas de la cuadrícula vertical menores
    panel.grid.major.y = element_blank(), # Elimina líneas de la cuadrícula horizontal
    panel.grid.minor.y = element_blank()) +  # Elimina la leyenda si no es necesaria
  coord_flip()  # Opcional: voltear el gráfico si hay muchas categorías para mejorar la legibilidad

...
q8<-calculate_tabulates(base=datos1,
                        x='q8_country',
                        y='q7_region_one',
                        add.totals = 'row')
...
# Ordenar el data frame si es necesario
# funding_summary <- funding_summary %>% arrange(Category)
...
q15<-q15_select%>% 
  ...
  mutate(Percentage=round(n/403*100,1)) %>% 

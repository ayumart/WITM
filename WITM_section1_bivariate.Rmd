...
q6q5<-base %>%
  ...
  select(q5_registered,Scope=q6_geo_scope,n,percentage)

#q6q5
qry_w<-q6q5  %>%
  select(q5_registered,Scope,percentage) %>% 
  pivot_wider(names_from = Scope, values_from = percentage)
qry_w
...
#q6q5
qry_w<-q6q5  %>%
  select(q5_registered,Scope,n) %>% 
  pivot_wider(names_from = Scope, values_from = n)
qry_w

write.xlsx2(as.data.frame(qry_w), "cuadros\\section_1.xlsx", row.names = FALSE, sheetName ="scop_by_reg_abs",append = TRUE)    
...
reg_1
write.xlsx2(as.data.frame(reg_1), "cuadros\\section_1.xlsx", row.names = FALSE, sheetName ="region_by_reg",append = TRUE)    
...
reg_2
write.xlsx2(as.data.frame(reg_2), "cuadros\\section_1.xlsx", row.names = FALSE, sheetName ="region_by_scope",append = TRUE)    
...
reg_2
write.xlsx2(as.data.frame(reg_2), "cuadros\\section_1.xlsx", row.names = FALSE, sheetName ="region_by_year",append = TRUE)    
...
write.xlsx2(as.data.frame(qry_w), "cuadros\\section_1.xlsx", row.names = FALSE, sheetName ="year_by_reg",append = TRUE)    
...
write.xlsx2(as.data.frame(qry_w), "cuadros\\section_1.xlsx", row.names = FALSE, sheetName ="year_by_scope",append = TRUE)    
